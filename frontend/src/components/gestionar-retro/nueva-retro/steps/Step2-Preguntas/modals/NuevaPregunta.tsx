...
const NuevaPregunta: FC<NuevaPreguntaProps> = ({
  ...
  const handleNewPregunta = async () => {
    ...
    if (newPregunta.id_tipo_pregunta === 3 && opciones.length === 1) {
    ...
    <Blanket isTinted>
      ...
      >
        <div className="flex flex-col bg-white rounded p-10 gap-8 items-center justify-center drop-shadow-lg min-w-[40vw] max-w-[55vw]">
          ...
          <div className="w-full flex flex-col gap-6 h-fit max-h-[55vh] px-2 overflow-y-auto pb-2">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                name="pregunta"
                className={`${
                  isErrorPregunta ? 'border-red-300' : 'border-gray'
