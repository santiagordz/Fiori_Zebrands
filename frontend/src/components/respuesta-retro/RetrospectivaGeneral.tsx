...
const RetrospectivaGeneral: FC<RetrospectivaGeneralProps> = ({  }) => {
  return (
    <div className='flex py-6 '> {/* Div de todo lo que va adentro de la parte azul */}
      <div className='flex flex-col py-3 px-5 w-full rounded bg-white border border-solid border-gray-300 border-collapse'> {/* Div del rectángulo blanco */}
        <div className='flex w-full justify-between '> {/* Div de la parte superior */}
          <div className='gap-4 flex flex-row'>{/* Div del Icono y título */}
            ...
            <h3 className='font-bold'>Retrospectiva Sprint 3</h3>
          </div>
        ...
        <div className='flex py-5 text-sm'> {/* Div del texto  */}
          <p>La retrospectiva tiene como fin evaluar el rendimiento tanto personal como del equipo en el Sprint 3, tomar en cuenta tu desempeño durante todo el periodo.</p>
        </div>
        <div className='flex flex-row text-xs justify-between'> {/* Div de la parte de hasta abajo */}
          <p>Fecha de Inicio: 07/Marzo/2023 </p>
          <ChevronRightLargeIcon label='flecha' primaryColor='#1D7AFC' />
        </div>
      </div>
    </div>
  )
