  ...
  return (
    <div className='p-5'>
      <button className='flex flex-row items-center'>
        ...
        />
        <p className='font-semibold text-base'>Volver a gestionar retrospectivas</p>
      </button>
      ...
      <div className='text-center py-[8vmin]'>
        <h3 className='text-[#0C66E4] text-sm font-bold'> PASO {selectedIndex + 1}/3</h3>
        <h1 className='text-[#5E4DB2] font-bold text-2xl'>Selecciona las Preguntas</h1>
        <p className='text-[#44546F]'>Elige las preguntas necesarias para satisfacer las necesidades de la retrospectiva.</p>
      </div>
      ...
      <div className='flex flex-row place-content-center justify-center gap-[10vmin] py-[2vmax]'>
        ...
        appearance='subtle' isDisabled={selectedIndex === 0} onClick={handlePrev}>
