  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`invisible overflow-hidden whitespace-nowrap flex flex-col bg-white h-[100vh] items-center drop-shadow py-12 fixed left-0 lg:visible top-0 z-[10000000000000]`}
      >
